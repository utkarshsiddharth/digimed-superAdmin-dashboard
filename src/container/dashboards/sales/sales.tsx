    ...
    <Fragment>
            ...
            <Card.Body>
              <Row>
                <div className="col-6 pe-0">
                  ...
                  <Link to="#" className="fs-12 mb-0 text-primary">
                    Show full stats<i className="ti ti-chevron-right ms-1"></i>
                  </Link>
                </div>
                <div className="col-6">
      ...
      <Row>
            ...
            <Tab.Container defaultActiveKey="1">
              <Card.Header className="card-header d-sm-flex d-block">
                ...
                <div className="mt-sm-0 mt-2">
                  ...
                  >
                    <i className="ti ti-plus me-1 fw-semibold align-middle d-inline-block"></i>
                    Add Task
                  </Button>
                </div>
              </Card.Header>
        ...
        <Col xxl={6} xl={12} md={12}>
          <Card className="custom-card">
            <Card.Header className="justify-content-between">
              <Card.Title>Visitors By Countries</Card.Title>
              <Dropdown>
                <Dropdown.Toggle
                  variant=""
                  aria-label="anchor"
                    ...
                    <ul className="list-unstyled p-4 my-auto">
                      <li className="mb-3">
                        <span className="fs-12">
                          <i className="ri-checkbox-blank-circle-fill align-middle me-2 d-inline-block text-primary"></i>
                          Usa
                        </span>
                      ...
                      <li className="mb-3">
                        <span className="fs-12">
                          <i className="ri-checkbox-blank-circle-fill align-middle me-2 d-inline-block text-secondary"></i>
                          India
                        </span>
                      ...
                      <li className="mb-3">
                        <span className="fs-12">
                          <i className="ri-checkbox-blank-circle-fill align-middle me-2 d-inline-block text-danger"></i>
                          Vatican City
                        </span>
                      ...
                      <li className="mb-3">
                        <span className="fs-12">
                          <i className="ri-checkbox-blank-circle-fill align-middle me-2 d-inline-block text-info"></i>
                          Canada
                        </span>
                      ...
                      <li className="mb-3">
                        <span className="fs-12">
                          <i className="ri-checkbox-blank-circle-fill align-middle me-2 d-inline-block text-orange"></i>
                          Mauritius
                        </span>
                      ...
                      <li className="mb-3">
                        <span className="fs-12">
                          <i className="ri-checkbox-blank-circle-fill align-middle me-2 d-inline-block text-warning"></i>
                          Singapore
                        </span>
                      ...
                      <li className="mb-3">
                        <span className="fs-12">
                          <i className="ri-checkbox-blank-circle-fill align-middle me-2 d-inline-block text-success"></i>
                          Palau
                        </span>
                      ...
                      <li className="mb-3">
                        <span className="fs-12">
                          <i className="ri-checkbox-blank-circle-fill align-middle me-2 d-inline-block text-pink"></i>
                          Maldives
                        </span>
                      ...
                      <li className="mb-0">
                        <span className="fs-12">
                          <i className="ri-checkbox-blank-circle-fill align-middle me-2 d-inline-block"></i>
      ...
      <Row>
        ...
        <Col xxl={3} xl={6}>
          <Card className="custom-card">
            <Card.Header className="card-header justify-content-between">
              <Card.Title>Sale Value</Card.Title>
              <Dropdown>
                <Dropdown.Toggle
                  variant=""
                  aria-label="anchor"
