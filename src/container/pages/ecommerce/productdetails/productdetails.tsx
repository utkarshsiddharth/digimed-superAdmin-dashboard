                                                ...
                                                <div className="mb-4">
                                                    <ul className="list-group">
                                                        ...
                                                        <li className="list-group-item border-top-0">
                                                            <Link className="text-success fs-12" data-bs-toggle="collapse" to="#offers-more" role="button" aria-expanded="false" aria-controls="offers-more"><u>More Offers</u></Link>
                                                        </li>
                                                    </ul>
                                                </div>
                                                <div className="mb-4">
