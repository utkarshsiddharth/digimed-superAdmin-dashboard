    ...
    useEffect(() => {
        function handleResize() {
            if (window.innerWidth <= 992) {
                ...
                ThemeChanger({ ...theme.reducer, "toggled": "close", "dataNavLayout": "horizontal" });
            } else {
                const theme = store.getState();
                ThemeChanger({ ...theme.reducer, "toggled": "open", "dataNavLayout": "horizontal" });
            }
        }
                        ...
                        <nav className="main-menu-container nav nav-pills sub-open">
                            ...
                            <div className="d-lg-flex d-none">
                                <div className="btn-list d-lg-flex d-none mt-lg-2 mt-xl-0 mt-0">
                                    ...
                                    <Button variant='' className="btn btn-wave btn-icon btn-light" data-bs-toggle="offcanvas" onClick={() => Switchericon()} data-bs-target="#switcher-canvas">
                                        <i className="ri-settings-3-line"></i>
                                    </Button>
                                </div>
                            </div>
                            ...
                            <Col xxl={3} xl={3} lg={6} md={6} sm={12}>
                                <Card className="custom-card text-center team-card ">
                                    <Card.Body className="card-body p-5">
                                        ...
                                        <div className="mt-2">
                                            <Button variant='' className="btn btn-light">View profile</Button>
                                        </div>
                                    </Card.Body>
                                </Card>
                            </Col>
