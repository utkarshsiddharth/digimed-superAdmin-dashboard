...
export function Light(actionfunction: any) {
    ...
    actionfunction({
        ...
        "dataHeaderStyles": "light",
            ...
            "bodyBg2" : "",
            "inputBorder" : "",
        "dataMenuStyles": theme.reducer.dataNavLayout == 'horizontal' ? 'light' : "dark"
...
export function Enable(actionfunction: any) {
    const theme = store.getState();
    actionfunction({ ...theme.reducer, loader: "enable" });
...
export function Disable(actionfunction: any) {
    const theme = store.getState();
    actionfunction({ ...theme.reducer, loader: "disable" });
