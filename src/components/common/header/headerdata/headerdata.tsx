...
export const Sidebarcomponents = [
  ...
  {
    path: `${import.meta.env.BASE_URL}dashboards/MedicineSet`,
    title: "MedicineSet",
  },
  {
  ...
  { path: `${import.meta.env.BASE_URL}dashboards/join` },
  { path: `${import.meta.env.BASE_URL}dashboards/petientList/frontPetient/` },

  // koise==============
  { path: `${import.meta.env.BASE_URL}koisedashboards/koisefornt` },

  { path: `${import.meta.env.BASE_URL}koisedashboards/koiskdashboard` },
  {
    path: `${
      import.meta.env.BASE_URL
    }koisedashboards/koiskdashboard/findpetient`,
  },
  {
    path: `${
      import.meta.env.BASE_URL
  ...
  },
  {
    path: `${
      import.meta.env.BASE_URL
    }koisedashboards/koiskdashboard/callcenter`,
  },
  ...
  { path: `${import.meta.env.BASE_URL}dashboards/petientList/`, title: "Nft" },
...

  {
    ...
    title: "Lockscreenbasic",
  },
  {
    path: `${
      import.meta.env.BASE_URL
    }authentication/lockscreen/lockscreencover`,
    title: "Lockscreencover",
  },
